...
| 범위 | 국내 가요·K-POP | **한국 드라마만** |
| 수록 | 305곡 (1980~2026) | 230개 (1992~2025) |
...
재생이 안 되면 설정의 **연결 진단** 을 누릅니다. Client ID · 토큰 · 계정 등급 ·
대시보드 등록 · SDK · 기기 연결 · 곡 검색을 순서대로 짚어 어디서 막혔는지 보여줍니다.
원인이 요금제인지 설정인지 코드인지 구분하려고 만들었습니다.
...
- **보컬곡만 씁니다.** 듣고 맞히는 게임이라 배경음악(스코어)은 쓸 수 없습니다.
  음악감독 이름으로 올라온 트랙과 `Main Theme`·`Opening` 류는 후순위로 밀고,
  보컬 대안이 없으면 그 작품을 아예 뺍니다
- **한국 영화는 전부 뺐습니다.** 스코어 위주라 가사 있는 OST 가 드물어
  드라마만으로 채우는 편이 품질이 높습니다
